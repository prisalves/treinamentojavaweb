...
set app=app06
echo compilando %app% ...
javac -classpath "D:\Cursos\JAVA CAP\Workspace\treinamentojavaweb\code\workspace\servidor\apache-tomcat-9.0.35\lib\servlet-api.jar" %app%\src\HelloServlet.java
