...
<body>
	...
	<div id="content-container" class="row-app" role="content">
		...
		<div id="content" class="small-10 large-10 columns" style="padding-top: 20px;">
			...
			<h3>Fornecedor <small>Atualizar</small></h3>
			...
			<form action="main" method="post">
				...
				<div class="row">
				    <div class="small-4 large-4 columns">
				      <label>#
				        <input name="id" type="text" value="${vendor.id}" />
				      </label>
				     </div>
				     <div class="small-8 large-8 columns">
				      <label>Nome
				        <input name="name" type="text" placeholder="Informe o nome" value="${vendor.name}" />
				      </label>
				    </div>
				</div>
				<div class="row">
					<div class="small-12 large-12 columns">
				      <label>Descrição
				        <input name="description" type="text" placeholder="Informe uma descrição" value="${vendor.description}" />
				      </label>
				    </div>
				</div>
				<div class="row">
					<div align="right" class="small-12 large-12 columns">
						<ul class="button-group radius">
						  <li><a href="listvendor.jsp" class="small button">Cancelar</a></li>
						  <li><button type="submit" form="frmapagar" class="small button secondary">Apagar</button></li>
