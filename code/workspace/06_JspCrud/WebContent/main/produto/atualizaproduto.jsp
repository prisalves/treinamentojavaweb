			...
			<form action="main" method="post">
				<div class="row">
				    <div class="small-4 large-4 columns">
				      <label>Nome
				        <input name="fornecedor" type="text" placeholder="Informe o fornecedor" />
				      </label>
				    </div>
				...
				<div class="row">
				    <div class="small-3 large-3 columns">
				      <label>Lote
				        <input name="fornecedor" type="text" placeholder="Informe o lote" />
				      </label>
				    </div>
				    <div class="small-3 large-3 columns">
				      <label>Quantidade
				        <input name="nome" type="text" placeholder="Informe a quantidade" />
				      </label>
				    </div>
				     <div class="small-3 large-3 columns">
				      <label>Vlr. de Compra
				        <input name="fornecedor" type="text" placeholder="Informe o valor para compra" />
				      </label>
				    </div>
				    <div class="small-3 large-3 columns">
				      <label>Vlr. de Venda
				        <input name="nome" type="text" placeholder="Informe o valor para venda" />
				      </label>
				    </div>
				</div>
				<div class="row">
					<div class="small-12 large-12 columns">
					  <label>Descrição
				        <input name="descricao" type="text" placeholder="Informe a descrição" />
				      </label>
					</div>
				</div>
				<div class="row">
					<div align="right" class="small-12 large-12 columns">
						<ul class="button-group radius">
						  ...
						  <li><a href="#" class="small button secondary">Apagar</a></li>
						  <li><a href="#" class="small button success">Atualizar</a></li>
						</ul>
					</div>
				</div>
			</form>
